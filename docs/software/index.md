...
|---|---|---|---|
| **ESPHome** (firmware) | En cada ESP32; se compila desde el add-on de HA o desde tu laptop | ≥ 2025.1 (`min_version` en cada YAML); los tres YAML de este repo pasan `esphome config` en ESPHome 2026.6.5 (verificado el 2026-09-16) | [`firmware/esphome/`](https://github.com/AndresIslas99/HomeGreen/tree/main/firmware/esphome): `nodo-riego-v1.yaml`, `nodo-ambiente.yaml`, `nodo-nft-v2.yaml`, `secrets.example.yaml` → [Firmware](firmware.md) |
