...
1. **Escribe el alcance y pide 3 cotizaciones.** Manda el mismo texto a los tres (apps tipo Cronoshare o recomendación de vecinos; referencia nacional de instalación completa $200–270/m² en [Cronoshare](https://www.cronoshare.com.mx/cuanto-cuesta/instalacion-electrica), que no aplica directo al patio):
    ...
    3. Contacto dúplex resistente a intemperie (WR) con tapa tipo "in-use" (protege con la clavija puesta) a 1.2 m en el poste que te señalo.
...
3. **Elige el punto del contacto y la ruta del conduit** con el electricista, antes de que perfore nada: contacto a **1.2 m** en el poste sureste del túnel, junto a donde irá GAB-1 ([Fase 1 · Automatización v1 paso 11](../fases/fase-1/automatizacion-v1.md)), fuera del alcance de los nebulizadores y del goteo del techo; ruta del conduit por muro o poste, no cruzando el paso ni bajo la canaleta; longitud ≤ 18 m para cal. 12 a 20 A (la carga real es < 5 A: sobra; [Diseño eléctrico · tabla de cableado](../diseno/electrico.md)). *Criterio de listo:* punto marcado con pintura y metros de conduit anotados en la cotización.
