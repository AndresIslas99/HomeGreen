...
| Manejo Higiénico de Alimentos (el estándar que exige el Distintivo H) | Varios proveedores en línea [POR VERIFICAR: proveedor y costo] | [POR VERIFICAR: pregunta al área de compras del primer hotel o restaurante que te lo pida qué constancia aceptan y con quién; cotiza dos y anota precio y vigencia] | En línea | Constancia que pide el área de compras de hoteles para ti y cualquier ayudante | Fase 1–2 | — |
...
```mermaid
gantt
    title Calendario de cursos (año tipo)
    dateFormat YYYY-MM-DD
    axisFormat %b
    section Ya
    Intagri NFT (promo $0 hasta 1-ene)      :crit, i1, 2026-09-15, 2027-01-01
    COFEPRIS frutas y hortalizas ($0)       :c1, 2026-09-15, 2026-12-31
    Edutin / Formencia ($0)                 :e1, 2026-10-01, 2026-12-31
    section 2027
    Convocatoria Escuela de Huertos SEDEMA  :milestone, s1, 2027-02-15, 0d
    Escuela de Huertos (16 sesiones)        :s2, 2027-03-15, 2027-11-30
    Intagri riego y nutrición ($1,113)      :i2, 2027-05-01, 2027-05-31
```
